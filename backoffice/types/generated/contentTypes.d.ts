...
export interface ApiProjectTaskProjectTask extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    editer: Schema.Attribute.RichText &
      ...
      >;
    estimated_cost_usd: Schema.Attribute.Integer &
      Schema.Attribute.DefaultTo<0>;
    estimated_time_minute: Schema.Attribute.Integer;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    publishedAt: Schema.Attribute.DateTime;
    task_phase: Schema.Attribute.Relation<
      'manyToOne',
      'api::task-phase.task-phase'
    >;
    task_type: Schema.Attribute.Relation<
      'manyToOne',
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    official_telegram: Schema.Attribute.String;
    official_website: Schema.Attribute.String;
    official_x: Schema.Attribute.String;
    project_description: Schema.Attribute.Text;
    project_logo: Schema.Attribute.Media<'images' | 'files'> &
      Schema.Attribute.Required;
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    raise_funds_usd: Schema.Attribute.BigInteger;
    start_date: Schema.Attribute.Date;
    tagline: Schema.Attribute.String;
    total_actual_cost_usd: Schema.Attribute.Integer;
    total_estimated_cost_usd: Schema.Attribute.Integer;
    total_estimated_time_minute: Schema.Attribute.Integer;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    valuation_usd: Schema.Attribute.BigInteger;
  };
}

export interface ApiTaskPhaseTaskPhase extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    name: Schema.Attribute.String;
    project: Schema.Attribute.Relation<'oneToOne', 'api::project.project'>;
    project_tasks: Schema.Attribute.Relation<
      'oneToMany',
      'api::project-task.project-task'
    >;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiUserProjectManagementUserProjectManagement
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::user-project-management.user-project-management'
    > &
      Schema.Attribute.Private;
    project: Schema.Attribute.Relation<'oneToOne', 'api::project.project'>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    user_project_management: Schema.Attribute.Relation<
      'oneToOne',
      'api::user-project-management.user-project-management'
    >;
    username: Schema.Attribute.String &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::task-phase.task-phase': ApiTaskPhaseTaskPhase;
      'api::task-type.task-type': ApiTaskTypeTaskType;
      'api::user-project-management.user-project-management': ApiUserProjectManagementUserProjectManagement;
